...
@Component({
  ...
  standalone: true,
  imports: [ObserveSectionDirective, NgFor, MatIcon, TranslateModule],
...
export class MyWorkComponent {
  ...
  projects = [
    {
      descriptionKey: "PROJECTS.EL_POLLO_LOCO",
      name: "El Pollo Loco",
      ...
      redirect:"https://nils-neumann.developerakademie.net/el-pollo/index.html",
      bgColor: this.orange,
    ...
    },
    {
      ...
      redirect:"https://nils-neumann.developerakademie.net/join/index.html",
